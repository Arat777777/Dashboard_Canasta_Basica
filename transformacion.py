...
# --- CORRECCIÓN IMPORTANTE — evita perder columnas de Calimax
...
def calcular_promedios(df):
    ...
    # Si existe la columna "Precio promedio categoría"
...
# Ordenar columnas (opcional pero recomendado)
columnas_orden = [
    "Producto buscado",
    "Categoria",
    "Nombre",
...
columnas_a_eliminar = [
    ...
    "Precio_limpio",
    "Ciudad",
    "Presentación"   # <-- Si la quieres conservar, quita esta línea
]
